...
# setup llvm
RUN wget --progress=bar:force:noscroll https://github.com/MLIR-China/stage/releases/download/nightly-tag-2022-10-22-0342/llvm-install-Release.zip -O llvm-install.zip && \
