...
# setup llvm
RUN wget --progress=bar:force:noscroll https://github.com/MLIR-China/stage/releases/download/nightly-tag-2022-10-18-0908/llvm-install-MinSizeRel.zip -O llvm-install.zip && \
