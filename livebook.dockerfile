...
# setup llvm
RUN wget --progress=bar:force:noscroll https://github.com/MLIR-China/stage/releases/download/nightly-tag-2022-10-24-0150/llvm-install-x86_64-unknown-linux-gnu-MinSizeRel.zip -O llvm-install.zip && \
