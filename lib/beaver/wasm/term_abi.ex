defmodule Beaver.Wasm.TermABI do
  ...
  @intrinsics %{
    ...
    "ex.term.result_atom_name" => %{params: [:i64, :i64], result: :i64},
    ...
    "ex.term.monitor" => %{params: [:i64, :i64, :i64, :i64], result: :i64},
    "ex.term.demonitor" => %{params: [:i64], result: :i64},
    ...
    "ex.term.integer_add" => %{params: [:i64, :i64], result: :i64},
    "ex.term.integer_sub" => %{params: [:i64, :i64], result: :i64},
    "ex.term.integer_mul" => %{params: [:i64, :i64], result: :i64},
    "ex.term.integer_div" => %{params: [:i64, :i64], result: :i64},
    "ex.term.integer_rem" => %{params: [:i64, :i64], result: :i64},
    ...
    "ex.term.list_insert_at" => %{params: [:i64, :i64, :i64], result: :i64},
    ...
    "ex.term.bigint_lit" => %{params: [:i64], result: :i64},
    ...
    "ex.term.int_to_string_base" => %{params: [:i64, :i64], result: :i64},
    ...
    "ex.term.enumerable_map_term_fun_c" => %{
