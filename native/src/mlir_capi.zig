...
pub const MemoryEffectInstancesList = MLIRKind("MemoryEffectInstancesList");
pub const MemoryEffectsOpInterfaceCallbacks = MLIRKind("MemoryEffectsOpInterfaceCallbacks");
